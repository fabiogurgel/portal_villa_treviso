...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { categoria_id: @produto.categoria_id, descricao: @produto.descricao, fornecedor_id: @produto.fornecedor_id, quant_minima: @produto.quant_minima, unidade: @produto.unidade, valor: @produto.valor } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { categoria_id: @produto.categoria_id, descricao: @produto.descricao, fornecedor_id: @produto.fornecedor_id, quant_minima: @produto.quant_minima, unidade: @produto.unidade, valor: @produto.valor } }
