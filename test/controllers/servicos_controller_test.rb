...
class ServicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servico" do
    assert_difference('Servico.count') do
      post servicos_url, params: { servico: { area_id: @servico.area_id, data: @servico.data, descricao: @servico.descricao, lista_produto_id: @servico.lista_produto_id, pessoa: @servico.pessoa, references: @servico.references } }
    end
  ...
  test "should update servico" do
    patch servico_url(@servico), params: { servico: { area_id: @servico.area_id, data: @servico.data, descricao: @servico.descricao, lista_produto_id: @servico.lista_produto_id, pessoa: @servico.pessoa, references: @servico.references } }
