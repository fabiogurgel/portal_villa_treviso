...
class SubAreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sub_area" do
    assert_difference('SubArea.count') do
      post sub_areas_url, params: { sub_area: { area_id: @sub_area.area_id, descricao: @sub_area.descricao, produto_id: @sub_area.produto_id } }
    end
  ...
  test "should update sub_area" do
    patch sub_area_url(@sub_area), params: { sub_area: { area_id: @sub_area.area_id, descricao: @sub_area.descricao, produto_id: @sub_area.produto_id } }
