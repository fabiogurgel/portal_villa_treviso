...
class CategoriasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categoria" do
    assert_difference('Categoria.count') do
      post categorias_url, params: { categoria: { codigo: @categoria.codigo, descricao: @categoria.descricao } }
    end
  ...
  test "should update categoria" do
    patch categoria_url(@categoria), params: { categoria: { codigo: @categoria.codigo, descricao: @categoria.descricao } }
